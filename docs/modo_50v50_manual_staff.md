...
[JUGADORES ENTRANDO AL SERVIDOR]
 ...
 └── ¿Eligen Rojo o Verde?
      ├── Primeros 10 segundos ──► Entran con amigos (tope 50 y máx 6 de dif).
      └── Pasado el segundo 10:
...
1. **La Puerta Libre (Primeros 10 segundos con tope de seguridad):**
   * Durante los primeros 10 segundos de la partida, la puerta está abierta para entrar con amigos y escuadras.
...
3. **El Portero en la Entrada (Del segundo 10 en adelante):**
   * Al cumplirse el segundo 10 sale el aviso definitivo:  
...
Amigos entrando al inicio (< 10s)              ✅ LIBRES (Tope 50 y máx 6 dif)
